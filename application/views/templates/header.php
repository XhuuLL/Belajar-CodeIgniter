...
<html lang="en">
  <>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/app-light.css') ?>" id="lightTheme" <?php echo (isset($_COOKIE['mode']) && $_COOKIE['mode'] == 'light') ? '' : 'disabled'; ?>>
    <link rel="stylesheet" href="<?= base_url('assets/css/app-dark.css') ?>" id="darkTheme" <?php echo (isset($_COOKIE['mode']) && $_COOKIE['mode'] == 'light') ? 'disabled' : ''; ?>>
  ...
  <body class="vertical <?php echo (isset($_COOKIE['mode'])) ? $_COOKIE['mode'] : 'dark'; ?>" id="main-body">